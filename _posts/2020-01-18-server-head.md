...
summary: "40명 파트원을 이끌며 서버 구축에 필요한 지식 전달, SOPT homepage 관리"
skill: "Node.js, Express, Database, MySQL, MongoDB, AWS Services, Git, Github, Network"
curriculum: "<h4>CURRICULUM</h4>
                    <p>
                        1주차 : Overview, javascript <br />
                        2주차 : Node.js + Express <br />
                        3주차 : 흐름제어, EC2 <br />
                        4주차 : Database, RDS <br />
                        5주차 : Multer - 이미지 다루기 <br />
                        6주차 : 인증, 보안 <br />
                        7주차 : 클라이언트 합동 세미나 <br />
                    </p>"
---
...
<h5>"열정"</h5>
7개월 동안, 그 어떤 대가를 바람없이 동아리에서
대학생 IT 창업 동아리 SOPT에서 약 7개월 간 서버파트장으로 활동했습니다. 7주차의 세미나를 통해 40명의 서버파트원에게 서버 지식을 전달했습니다.
