---
layout: post
duration: "2020.01.18 ~ 2020.03.01"
title: SOPT 지원 페이지 제작
tit: <span class="break-line800">SOPT 지원</span> 페이지 제작
image: "/assets/img/sopt-page.png"
permalink: project/sopt-page
---

<div class="sopt-page">

<div class="section1">
    <h5 class="quot-title"> 630명이 지원한 페이지 제작 </h5>
    <div class="main-img">
        <img src="/assets/img/sopt-page/26th_yb_apply_yb.png"/>
    </div>
</div>

<div class="section2">
    <h5 class="quot-title"> UX </h5>
    <div class="flex-box">
        <img class="left" src="/assets/img/sopt-page/alert.png"/>
    ...
    <div class="flex-box">
        ...
        <img class="right" src="/assets/img/sopt-page/server.png"/>
    </div>
</div>

<div class="section3">
    <h5 class="quot-title"> 지원서 확인 페이지 </h5>
    ...
    <div class="img-cont">
        <img class="right" src="/assets/img/sopt-page/check-server.png"/>
    </div>
</div>
</div>