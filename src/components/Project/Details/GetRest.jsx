                ...
                <div className="flex-box">
                    ...
                    <div>
                        ...
                        <a target="_blank" href="https://github.com/soptrest/sopt_get_rest_IOS">
                            <img src="https://img.icons8.com/fluent/96/000000/github.png" />  Gtihub 링크 </a>
                    </div>
                </div>
            </div>
            <div className="section3">
                {/* <div > */}
                <Slider {...settings} className="slider pdf-gallery">
                    {
                        pdfImage.map(pdfImg => (
                            <div className="img-cont">
                                <a  target="_blank" href={pdfImg}></a>
                                <img src={pdfImg} alt='storyboard' />
                            </div>
                        ))
                    }
                </Slider>
                <div className="g-cnt">
                    <Slider {...navSettings} className="slider pdf-nav">
                        {/* <div id="pdf-nav" className="slider pdf-nav"> */}
                        {
                            pdfImage.map(pdfImg => (
                                <img src={pdfImg} alt='storyboard' />
                            ))
